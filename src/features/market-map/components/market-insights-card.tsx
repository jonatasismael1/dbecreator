...
export function MarketInsightsCard({ insights, generatedAt }: MarketInsightsCardProps) {
  return (
    <Card className="mt-4 space-y-5 border-dbe-purple/20 bg-dbe-purple/5">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <InsightList icon={<Lightbulb className="h-4 w-4 text-dbe-amber" />} title="Oportunidades" items={insights.content_opportunities} />
